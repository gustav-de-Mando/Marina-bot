...
class Levels(commands.Cog):
    ...
    @commands.hybrid_command(name='profile',aliases=['level'],description='Zeigt Level und XP.')
    ...
    @commands.hybrid_command(name='leaderboard',aliases=['lb'],description='Server-Levelrangliste.')
    ...
    @commands.hybrid_command(name='setxp',description='Setzt XP eines Users.')
    ...
    @commands.hybrid_command(name='addxp',description='Fügt XP hinzu.')
    @commands.has_permissions(administrator=True)
    ...
    @commands.hybrid_command(name='levelrole',description='Setzt eine Rolle für ein Level.')
    ...
    @commands.hybrid_command(name='levelroles',description='Zeigt alle Levelrollen.')
    ...
    @commands.hybrid_command(name='levelroles_create',description='Erstellt automatisch Standard-Levelrollen.')
    @commands.has_permissions(manage_roles=True)
